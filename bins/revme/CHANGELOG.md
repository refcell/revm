...
## [4.0.0](https://github.com/refcell/revm/compare/revme-v3.0.0...revme-v4.0.0) - 2025-03-26

### Added

- Add JournalInner ([#2311](https://github.com/refcell/revm/pull/2311))
- Add criterion to revme bench command ([#2295](https://github.com/refcell/revm/pull/2295))

### Other

- bump bench time, and reduce burntpix iterations ([#2315](https://github.com/refcell/revm/pull/2315))
- update EOF validation logic and improve error handling ([#2304](https://github.com/refcell/revm/pull/2304))
