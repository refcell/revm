...
## [1.0.1](https://github.com/refcell/revm/compare/revm-inspector-v1.0.0...revm-inspector-v1.0.1) - 2025-03-26

### Other

- updated the following local packages: revm-primitives, revm-database-interface, revm-context, revm-database, revm-interpreter, revm-handler
