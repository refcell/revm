...
## [1.0.0-alpha.4](https://github.com/refcell/revm/compare/revm-inspector-v1.0.0-alpha.3...revm-inspector-v1.0.0-alpha.4) - 2025-03-10

### Fixed

- correct propagate features ([#2177](https://github.com/refcell/revm/pull/2177))

### Other

- remove CTX phantomdata from precompile providers ([#2178](https://github.com/refcell/revm/pull/2178))
