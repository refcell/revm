...
## [1.1.0](https://github.com/refcell/revm/compare/revm-handler-v1.0.0...revm-handler-v1.1.0) - 2025-03-26
...
- broken disable balance check ([#2286](https://github.com/refcell/revm/pull/2286))

### Other

- Remove LATEST variant from SpecId enum ([#2299](https://github.com/refcell/revm/pull/2299))
- add unit test for EIP-3860 initcode size limit ([#2302](https://github.com/refcell/revm/pull/2302))
