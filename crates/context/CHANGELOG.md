...
## [1.0.0-alpha.6](https://github.com/refcell/revm/compare/revm-context-v1.0.0-alpha.5...revm-context-v1.0.0-alpha.6) - 2025-03-20

### Fixed

- remove duplicated load_account() ([#2225](https://github.com/refcell/revm/pull/2225))

### Other

- Add custom instruction example ([#2261](https://github.com/refcell/revm/pull/2261))
- fix clippy ([#2238](https://github.com/refcell/revm/pull/2238))
