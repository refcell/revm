...
## [17.0.0-alpha.7](https://github.com/refcell/revm/compare/revm-precompile-v17.0.0-alpha.6...revm-precompile-v17.0.0-alpha.7) - 2025-03-20

### Added

- Return Fatal error on bls precompiles if in no_std ([#2249](https://github.com/refcell/revm/pull/2249))
- bls special case G1/G2_MUL ([#2248](https://github.com/refcell/revm/pull/2248))
...
- Adds a wrapper around substrate-bn for EIP196 ([#2258](https://github.com/refcell/revm/pull/2258))
- add invariant test for G1/G2 Mul ([#2247](https://github.com/refcell/revm/pull/2247))
- add documentation for the gas related constants for EIP2537 ([#2246](https://github.com/refcell/revm/pull/2246))
- add a safe blst wrapper ([#2223](https://github.com/refcell/revm/pull/2223))
- Remove redundant bls12-381 constants and cleanup naming ([#2235](https://github.com/refcell/revm/pull/2235))
- Add some documentation for the bls12-381 precompile constants ([#2222](https://github.com/refcell/revm/pull/2222))
