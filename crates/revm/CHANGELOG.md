...
## [20.1.0](https://github.com/refcell/revm/compare/revm-v20.0.0...revm-v20.1.0) - 2025-03-26

### Added

- Add JournalInner ([#2311](https://github.com/refcell/revm/pull/2311))
- Add a wrapper for arkworks for EIP196 ([#2305](https://github.com/refcell/revm/pull/2305))

### Other

- Propagate asyncdb feature flag from database-interface to revm  ([#2310](https://github.com/refcell/revm/pull/2310))
