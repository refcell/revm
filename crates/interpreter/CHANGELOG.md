...
## [16.0.1](https://github.com/refcell/revm/compare/revm-interpreter-v16.0.0...revm-interpreter-v16.0.1) - 2025-03-26

### Other

- Remove LATEST variant from SpecId enum ([#2299](https://github.com/refcell/revm/pull/2299))
- make number more readable ([#2300](https://github.com/refcell/revm/pull/2300))
